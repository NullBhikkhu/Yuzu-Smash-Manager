...
$sevenZipInstallerPath = "$yuzuArchivePath\dependencies\$sevenZipInstallerBasename"
...
$fileUrls = @(
    ...
    'https://cdn.discordapp.com/attachments/1121103766960226496/1188253223761485966/LDN_all_in_one_package.zip?ex=6599da0d&is=6587650d&hm=e3cea7384dad56f144346478b881e8439d16c43d94dc7964edab3b399f0a82fe&',
    'https://cdn.discordapp.com/attachments/890851835349446686/1191740302566891581/legacy_discovery?ex=65a689a5&is=659414a5&hm=b19cb9b22f67d4ca97da49b3b51c9242be57fb2124e74a894d072260225576fd&',
    'https://cdn.discordapp.com/attachments/890851835349446686/1191073579727597589/save_data.rar?ex=65a41cb6&is=6591a7b6&hm=635a5a953b6c7ce64d4dd6b2dbf6b280ed29dbce5f001bafd99c6486004db965&',
    'https://drive.usercontent.google.com/download?id=1f_idi29L7Poxg0Cljbi4oz9ubpukmdXY&export=download' # Warning! Might not be consistent.
)
...
function Ensure-Files {
    ...
    foreach ($url in $Urls) {
        ...
        # # Special handling of 7-Zip installer.
        # if ($url -eq $SevenZipInstallerName) {
...
New-Item -ItemType Directory -Path "$yuzuArchivePath\dependencies" -Force | Out-Null
...
# Ensure dependencies
Ensure-Files -Urls $fileUrls -DownloadDir "$yuzuArchivePath\dependencies"
